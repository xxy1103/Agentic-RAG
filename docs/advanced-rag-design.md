...
![Advanced RAG 的四层评测对象](image/advanced-rag-design/evaluation-layers.svg)
...
![自建数据集与 MultiHop-RAG 的评测职责](image/advanced-rag-design/dual-datasets.svg)
...
![五个 Profile 的能力递进关系](image/advanced-rag-design/profile-progression.svg)
...
![自建题集上的检索质量与延迟权衡](image/advanced-rag-design/quality-latency.svg)
...
![从固定 Advanced RAG 到 Agentic Multi-Hop RAG](image/advanced-rag-design/next-stage-agentic-vision.svg)
