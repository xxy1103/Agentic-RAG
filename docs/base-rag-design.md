...
![Base RAG 核心思想](image/base-rag-design/rag-overview.svg)
...
![Base RAG 离线建库与在线问答](image/base-rag-design/two-stage-pipeline.svg)
...
![Base RAG 工程模块架构](image/base-rag-design/module-architecture.svg)
...
![pipeline.py 编排完整 ingest 建库流程](image/base-rag-design/ingest-orchestration.svg)
...
![pipeline.py 编排完整 ask 在线问答流程](image/base-rag-design/ask-orchestration.svg)
...
![Base RAG 关键参数的影响路径](image/base-rag-design/parameter-effects.svg)
